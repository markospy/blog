...
export const SITE_TITLE = 'Marcos Avila - Página Personal';
...
/** Nombre del autor del sitio. Usado en meta tags, JSON-LD y RSS para que Google y lectores lo reconozcan. */
export const SITE_AUTHOR = 'Marcos Antonio Ávila Morales';
